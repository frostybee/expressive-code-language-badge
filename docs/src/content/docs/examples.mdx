...
## Example of Overridden Language Label

```cpp title="Example of Overridden Language Label"
#include <iostream>
int main() {
  std::cout << "Sixth code block" << std::endl;
  return 0;
}
```

```csharp title="Example of Overridden Language Label"
Console.WriteLine("Seventh code block");
```
